...
function change_brightness(c)
	...
	if(y<=0) then y=1 end
	awful.util.spawn_with_shell("xbacklight -set "..y.."%")
...
vicious.register(bat, vicious.widgets.bat, "$1$2%", 32, "BAT1")
...
globalkeys = awful.util.table.join(
	...
	awful.key({}, "#122", function() change_sound("5%-") end),
	awful.key({}, "#123", function() change_sound("5%+") end),
...
local uname = string.gsub(awful.util.pread("whoami"), "\n", "")
naughty.notify({title="Hello, "..uname.."!", text="Startup completed in"..x})
...
function wallpaper_cycle()
    wp_index = 1
    wp_timeout = 5
    wp_path = "/home/shivin/Dropbox/wallpaper/girls/"
    wp_files = {}
